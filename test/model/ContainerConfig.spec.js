...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModokiApiDocumentation.ContainerConfig();
  });
  ...
  describe('ContainerConfig', function() {
    it('should create an instance of ContainerConfig', function() {
      ...
      //var instance = new ModokiApiDocumentation.ContainerConfig();
      //expect(instance).to.be.a(ModokiApiDocumentation.ContainerConfig);
    });
